'''
Number of Provinces: There are n cities. Some of them are connected, while some are not. If city a is connected directly
...
print(sol.findCircleNum(isConnected1))  # Output: 2
