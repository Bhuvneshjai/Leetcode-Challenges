'''
Sales Person: Table: SalesPerson
+-----------------+---------+
| Column Name     | Type    |
+-----------------+---------+
| sales_id        | int     |
...
def sales_persons(sales_person: pd.DataFrame, company: pd.DataFrame, orders: pd.DataFrame) -> pd.DataFrame:
    ...
    print(red_company_ids)
    print()

    red_sales_id = orders[orders['com_id'].isin(red_company_ids)]['sales_id'].unique()
    print(red_sales_id)
    print()
...
result = sales_persons(sales_person, company, orders)
print(result)