'''
Find Users With Valid E-Mails: Table: Users
+---------------+---------+
| Column Name   | Type    |
+---------------+---------+
| user_id       | int     |
...
def valid_emails(users: pd.DataFrame) -> pd.DataFrame:
    ...
    return users[users['mail'].str.match(patterns, na=False)]
...
data = {
    ...
    'mail': [
        ...
        'jonathanisgreat',             # invalid (no domain)
        'bella-@leetcode.com',         # valid
        'sally.come@leetcode.com',     # valid
        'quarz#2020@leetcode.com',     # invalid (contains #)
        'david69@gmail.com',           # invalid (wrong domain)
        '.shapo@leetcode.com'          # invalid (starts with a dot)
    ]
}
